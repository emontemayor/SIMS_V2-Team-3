...
_acquire_agc::
	.ds 1
Lmain.process_ber$fourfsk$1$234==.
_process_ber_fourfsk_1_234:
	.ds 1
Lmain.process_ber$databyte$6$240==.
_process_ber_databyte_6_240:
	.ds 1
...
;--------------------------------------------------------
	...
	C$main.c$82$1$329 ==.
;	main.c:82: uint8_t __data coldstart = 1; // caution: initialization with 1 is necessary! Variables are initialized upon _sdcc_external_startup returning 0 -> the coldstart value returned from _sdcc_external startup does not survive in the coldstart case
	mov	_coldstart,#0x01
	.area GSFINAL (CODE)
...
;------------------------------------------------------------
	...
	C$main.c$123$0$0 ==.
;	main.c:123: static void pwrmgmt_irq(void) __interrupt(INT_POWERMGMT)
;	-----------------------------------------
...
_pwrmgmt_irq:
	...
	mov	psw,#0x00
	C$main.c$125$1$0 ==.
;	main.c:125: uint8_t pc = PCON;
	C$main.c$126$1$228 ==.
;	main.c:126: if (!(pc & 0x80))
	mov	a,_PCON
	mov	r7,a
	jb	acc.7,00102$
	C$main.c$127$1$228 ==.
...
00102$:
	C$main.c$128$1$228 ==.
;	main.c:128: GPIOENABLE = 0;
	mov	dptr,#_GPIOENABLE
	clr	a
	movx	@dptr,a
	C$main.c$129$1$228 ==.
;	main.c:129: IE = EIE = E2IE = 0;
...
;------------------------------------------------------------
	...
	C$main.c$135$1$228 ==.
;	main.c:135: static void correct_ber(void)
;	-----------------------------------------
...
;fourfsk                   Allocated with name '_process_ber_fourfsk_1_234'
;i                         Allocated to registers r3 
;p                         Allocated to registers r6 r7 
;databyte                  Allocated with name '_process_ber_databyte_6_240'
...
;------------------------------------------------------------
	...
	C$main.c$157$1$230 ==.
;	main.c:157: static void process_ber(struct axradio_status __xdata *st)
;	-----------------------------------------
...
_process_ber:
	...
	mov	r7,dph
	C$main.c$159$1$234 ==.
;	main.c:159: uint8_t fourfsk = (AX5043_MODULATION & 0x0F) == 9;
	...
	inc	a
00176$:
	mov	_process_ber_fourfsk_1_234,a
	C$main.c$161$2$235 ==.
;	main.c:161: uint8_t i = st->u.rx.pktlen;
	mov	a,#0x06
	add	a,r6
	mov	r6,a
	clr	a
...
;	main.c:162: bytes -= i;
	...
	mov	(_bytes + 3),a
	C$main.c$163$2$235 ==.
;	main.c:163: acquire_agc = (0 > (int32_t)bytes);
	mov	r0,_bytes
	mov	r1,(_bytes + 1)
	mov	r2,(_bytes + 2)
	mov	a,(_bytes + 3)
	...
	rlc	a
	C$main.c$164$2$235 ==.
;	main.c:164: if (acquire_agc) {
	mov	_acquire_agc,a
	jz	00102$
	C$main.c$165$3$236 ==.
;	main.c:165: i += (uint8_t)bytes;
	mov	a,_bytes
	mov	r4,a
	add	a,r3
	mov	r3,a
...
00179$:
	C$main.c$169$3$237 ==.
;	main.c:169: const uint8_t __xdata *p = st->u.rx.pktdata;
	mov	a,#0x14
	add	a,r6
	mov	dpl,a
	clr	a
	...
	mov	r7,a
	C$main.c$172$4$238 ==.
;	main.c:172: if (fourfsk) {
	mov	a,_process_ber_fourfsk_1_234
	jz	00143$
	C$main.c$173$1$234 ==.
;	main.c:173: do {
...
00104$:
	C$main.c$174$6$240 ==.
;	main.c:174: uint8_t databyte = *p++;
	mov	dpl,_process_ber_sloc1_1_0
	mov	dph,(_process_ber_sloc1_1_0 + 1)
	movx	a,@dptr
	mov	_process_ber_databyte_6_240,a
	inc	dptr
	mov	_process_ber_sloc1_1_0,dpl
	mov	(_process_ber_sloc1_1_0 + 1),dph
	C$main.c$176$6$240 ==.
;	main.c:176: errors2 += hweight8(databyte ^ 0x87);
	mov	a,#0x87
	xrl	a,_process_ber_databyte_6_240
	mov	dpl,a
	lcall	_hweight8
	mov	r5,dpl
	mov	ar0,r5
	...
	mov	(_errors2 + 3),a
	C$main.c$177$6$240 ==.
;	main.c:177: errors += hweight8(databyte ^ 0xe1);
	mov	a,#0xe1
	xrl	a,_process_ber_databyte_6_240
	mov	dpl,a
	lcall	_hweight8
...
;	main.c:182: uint8_t databyte = *p++;
	...
	mov	r7,dph
	C$main.c$183$5$241 ==.
;	main.c:183: errors += hweight8(databyte ^ 0x55);
	mov	a,#0x55
	xrl	a,r4
	mov	dpl,a
	lcall	_hweight8
...
00126$:
	C$main.c$221$1$234 ==.
;	main.c:221: if (!acquire_agc)
	mov	a,_acquire_agc
	C$main.c$222$1$234 ==.
;	main.c:222: return;
	jz	00137$
	C$main.c$224$1$234 ==.
;	main.c:224: if (errors > (((uint32_t)NUMBYTES) << 2))
	clr	c
	mov	a,#0x88
	subb	a,_errors
	mov	a,#0x13
	...
	jnc	00130$
	C$main.c$225$1$234 ==.
;	main.c:225: errors = (((uint32_t)NUMBYTES) << 3) - errors;
	mov	a,#0x10
	clr	c
	subb	a,_errors
	mov	_errors,a
...
00130$:
	C$main.c$226$1$234 ==.
;	main.c:226: if (fourfsk) {
	mov	a,_process_ber_fourfsk_1_234
	jz	00136$
	C$main.c$227$2$245 ==.
;	main.c:227: if (errors2 > (((uint32_t)NUMBYTES) << 2))
	clr	c
	mov	a,#0x88
	subb	a,_errors2
	mov	a,#0x13
	...
	jnc	00132$
	C$main.c$228$2$245 ==.
;	main.c:228: errors2 = (((uint32_t)NUMBYTES) << 3) - errors2;
	mov	a,#0x10
	clr	c
	subb	a,_errors2
	mov	_errors2,a
...
;	main.c:229: if (errors2 < errors)
	...
	jnc	00136$
	C$main.c$230$2$245 ==.
;	main.c:230: errors = errors2;
	mov	_errors,_errors2
	mov	(_errors + 1),(_errors2 + 1)
	mov	(_errors + 2),(_errors2 + 2)
	mov	(_errors + 3),(_errors2 + 3)
00136$:
	C$main.c$232$1$234 ==.
;	main.c:232: correct_ber();
	lcall	_correct_ber
00137$:
	C$main.c$233$1$234 ==.
...
;------------------------------------------------------------
	Fmain$dump_pkt$0$0 ==.
	C$main.c$235$1$234 ==.
;	main.c:235: static void dump_pkt(struct axradio_status __xdata *st)
;	-----------------------------------------
;	 function dump_pkt
;	-----------------------------------------
_dump_pkt:
...
00102$:
	C$main.c$241$2$248 ==.
;	main.c:241: const uint8_t __xdata *p = st->u.rx.pktdata;
	mov	a,#0x06
	add	a,r6
	mov	r6,a
	clr	a
	...
	mov	r5,a
	C$main.c$242$2$248 ==.
;	main.c:242: uint8_t i = st->u.rx.pktlen, j;
	mov	a,#0x16
	add	a,r6
	mov	dpl,a
	clr	a
...
00127$:
	C$main.c$245$4$250 ==.
;	main.c:245: dbglink_tx('\n');
	mov	dpl,#0x0a
	lcall	_dbglink_tx
	C$main.c$246$4$250 ==.
;	main.c:246: dbglink_writehex16(j, 4, WRNUM_PADZERO);
	mov	ar2,r7
	mov	r3,#0x00
	push	ar7
	push	ar6
	...
	pop	ar7
	C$main.c$247$4$250 ==.
;	main.c:247: dbglink_tx(':');
	mov	dpl,#0x3a
	lcall	_dbglink_tx
00104$:
	C$main.c$249$3$249 ==.
;	main.c:249: dbglink_tx(' ');
	mov	dpl,#0x20
	lcall	_dbglink_tx
	C$main.c$250$3$249 ==.
;	main.c:250: dbglink_writehex16(*p++, 2, WRNUM_PADZERO);
	mov	dpl,r4
	mov	dph,r5
	movx	a,@dptr
	mov	r3,a
...
;------------------------------------------------------------
;st                        Allocated to registers r6 r7 
;freqoffs                  Allocated to registers r4 r5 r6 r7 
;------------------------------------------------------------
	Fmain$display_ber$0$0 ==.
	C$main.c$257$2$248 ==.
;	main.c:257: static void display_ber(struct axradio_status __xdata *st)
;	-----------------------------------------
...
_display_ber:
	...
	mov	r7,dph
	C$main.c$259$1$252 ==.
;	main.c:259: int32_t freqoffs = axradio_conv_freq_tohz(st->u.rx.phy.offset);
	mov	a,#0x06
	add	a,r6
	mov	r6,a
	clr	a
	...
	mov	r7,a
	C$main.c$273$1$252 ==.
;	main.c:273: if (DBGLNKSTAT & 0x10) {
	mov	a,_DBGLNKSTAT
	jnb	acc.4,00119$
	C$main.c$274$2$261 ==.
;	main.c:274: dbglink_writestr("BER = 0.");
	mov	dptr,#___str_0
	mov	b,#0x80
	push	ar7
	push	ar6
	...
	C$main.c$275$2$261 ==.
;	main.c:275: dbglink_writenum32(errors, BERDIGITS, WRNUM_PADZERO);
	mov	a,#0x08
	push	acc
	rr	a
	push	acc
	...
	dec	sp
	C$main.c$276$2$261 ==.
;	main.c:276: dbglink_writestr("\tFOFFS = ");
	mov	dptr,#___str_1
	mov	b,#0x80
	lcall	_dbglink_writestr
	pop	ar4
	...
	pop	ar7
	C$main.c$277$2$261 ==.
;	main.c:277: dbglink_writenum32(freqoffs, 6, WRNUM_SIGNED);
	mov	a,#0x01
	push	acc
	mov	a,#0x06
	push	acc
...
;------------------------------------------------------------
	...
	C$main.c$284$1$252 ==.
;	main.c:284: void axradio_statuschange(struct axradio_status __xdata *st)
;	-----------------------------------------
;	 function axradio_statuschange
;	-----------------------------------------
_axradio_statuschange:
	C$main.c$286$1$263 ==.
;	main.c:286: switch (st->status) {
	mov	r6,dpl
	mov  r7,dph
	movx	a,@dptr
	mov	r5,a
...
00118$:
	C$main.c$304$3$269 ==.
;	main.c:304: axradio_transmit((void *)0, onepattern, sizeof(onepattern));
...
;	main.c:305: break;
	C$main.c$334$2$264 ==.
;	main.c:334: case AXRADIO_STAT_RECEIVE:
	sjmp	00157$
00126$:
	C$main.c$336$3$274 ==.
;	main.c:336: if (acquire_agc == 1) {
	mov	a,#0x01
	cjne	a,_acquire_agc,00134$
	C$main.c$338$6$277 ==.
;	main.c:338: led0_off();
	clr	_PORTC_3
	C$main.c$339$4$275 ==.
;	main.c:339: acquire_agc = 2;
	mov	_acquire_agc,#0x02
	C$main.c$340$4$275 ==.
;	main.c:340: axradio_agc_freeze();
...
00134$:
	C$main.c$343$3$274 ==.
;	main.c:343: if (acquire_agc == 2) {
	mov	a,#0x02
	cjne	a,_acquire_agc,00146$
	C$main.c$345$4$278 ==.
;	main.c:345: acquire_agc = 0;
...
;	main.c:369: process_ber(st);
	...
	pop	ar7
	C$main.c$373$3$274 ==.
;	main.c:373: if (!acquire_agc)
	mov	a,_acquire_agc
	jz	00157$
	C$main.c$375$3$274 ==.
;	main.c:375: axradio_agc_thaw();
	push	ar7
	push	ar6
	...
	pop	ar7
	C$main.c$376$3$274 ==.
;	main.c:376: display_ber(st);
	mov	dpl,r6
	mov	dph,r7
	lcall	_display_ber
	C$main.c$377$3$274 ==.
;	main.c:377: bytes = NUMBYTES;
	mov	_bytes,#0xe2
	mov	(_bytes + 1),#0x04
	clr	a
	mov	(_bytes + 2),a
...
;------------------------------------------------------------
	G$set_cw$0$0 ==.
	C$main.c$388$1$263 ==.
;	main.c:388: void set_cw(void)
;	-----------------------------------------
;	 function set_cw
;	-----------------------------------------
_set_cw:
	C$main.c$390$1$285 ==.
;	main.c:390: uint8_t i = axradio_set_mode(AXRADIO_MODE_CW_TRANSMIT);
	mov	dpl,#0x03
	lcall	_axradio_set_mode
	C$main.c$391$1$285 ==.
;	main.c:391: if (i != AXRADIO_ERR_NOERROR) {
	mov	a,dpl
	mov	r7,a
	mov	r6,a
	jz	00120$
	C$main.c$394$2$286 ==.
;	main.c:394: dbglink_display_radio_error(i);
	mov	dpl,r6
	lcall	_dbglink_display_radio_error
00118$:
	C$main.c$398$2$286 ==.
;	main.c:398: enter_sleep();
	lcall	_enter_sleep
	C$main.c$405$1$285 ==.
;	main.c:405: display_writestr(AX5043_MODCFGA & 0x02 ? "SE " : "   ");
	sjmp	00118$
00120$:
	C$main.c$406$1$285 ==.
	XG$set_cw$0$0 ==.
...
;------------------------------------------------------------
	G$set_transmit$0$0 ==.
	C$main.c$408$1$285 ==.
;	main.c:408: void set_transmit(void)
;	-----------------------------------------
;	 function set_transmit
;	-----------------------------------------
_set_transmit:
	C$main.c$429$1$295 ==.
;	main.c:429: i = axradio_set_mode(i);
	mov	dpl,#0x18
	lcall	_axradio_set_mode
	C$main.c$430$1$295 ==.
;	main.c:430: if (i != AXRADIO_ERR_NOERROR) {
	mov	a,dpl
	mov	r7,a
	mov	r6,a
	jz	00111$
	C$main.c$433$2$297 ==.
;	main.c:433: dbglink_display_radio_error(i);
	mov	dpl,r6
	lcall	_dbglink_display_radio_error
00138$:
	C$main.c$437$2$297 ==.
;	main.c:437: enter_sleep();
	lcall	_enter_sleep
	sjmp	00138$
00111$:
	C$main.c$439$1$295 ==.
;	main.c:439: scr.w = ~0U;
	...
	mov	(_scr + 1),#0xff
	C$main.c$465$1$295 ==.
;	main.c:465: display_writestr(AX5043_MODCFGA & 0x02 ? "SE " : "   ");
	C$main.c$466$1$295 ==.
	XG$set_transmit$0$0 ==.
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
	...
	C$main.c$468$1$295 ==.
;	main.c:468: void set_receiveber(void)
;	-----------------------------------------
;	 function set_receiveber
;	-----------------------------------------
_set_receiveber:
	C$main.c$489$1$311 ==.
;	main.c:489: i = axradio_set_mode(i);
	mov	dpl,#0x28
	lcall	_axradio_set_mode
	C$main.c$490$1$311 ==.
;	main.c:490: if (i != AXRADIO_ERR_NOERROR) {
	mov	a,dpl
	mov	r7,a
	mov	r6,a
	jz	00112$
	C$main.c$493$2$313 ==.
;	main.c:493: dbglink_display_radio_error(i);
	mov	dpl,r6
	lcall	_dbglink_display_radio_error
00128$:
	C$main.c$497$2$313 ==.
;	main.c:497: enter_sleep();
	lcall	_enter_sleep
	C$main.c$499$1$311 ==.
;	main.c:499: display_clear(0x00, 16);
	sjmp	00128$
00112$:
	C$main.c$510$1$311 ==.
;	main.c:510: bytes = NUMBYTES;
	mov	_bytes,#0xe2
	mov	(_bytes + 1),#0x04
	clr	a
	mov	(_bytes + 2),a
...
;	main.c:511: errors = 0;
	...
	mov	(_errors + 3),a
	C$main.c$512$1$311 ==.
;	main.c:512: errors2 = 0;
	mov	_errors2,a
	mov	(_errors2 + 1),a
	mov	(_errors2 + 2),a
	mov	(_errors2 + 3),a
	C$main.c$513$1$311 ==.
;	main.c:513: acquire_agc = 1;
...
;------------------------------------------------------------
	...
	C$main.c$529$1$311 ==.
;	main.c:529: uint8_t _sdcc_external_startup(void)
;	-----------------------------------------
;	 function _sdcc_external_startup
;	-----------------------------------------
__sdcc_external_startup:
	C$main.c$532$2$325 ==.
;	main.c:532: wtimer0_setclksrc(CLKSRC_LPOSC, 1);
	mov	dpl,#0x09
	lcall	_wtimer0_setconfig
	C$main.c$533$2$326 ==.
;	main.c:533: wtimer1_setclksrc(CLKSRC_FRCOSC, 7);
	mov	dpl,#0x38
	lcall	_wtimer1_setconfig
	C$main.c$535$1$324 ==.
;	main.c:535: coldstart = !(PCON & 0x40);
	mov	a,_PCON
	mov	c,acc[6]
	cpl	c
	...
	mov	_coldstart,a
	C$main.c$537$1$324 ==.
;	main.c:537: ANALOGA = 0x18; // PA[3,4] LPXOSC, other PA are used as digital pins
	mov	dptr,#_ANALOGA
	mov	a,#0x18
	movx	@dptr,a
	C$main.c$551$1$324 ==.
;	main.c:551: PORTA = 0xC0 | (PINA & 0x25); // pull-up for PA[6,7] which are not bonded, no pull up for PA[3,4] (LPXOSC). Output 0 in PA[0,1,2,5] to prevent current consumption in all DIP switch states
	mov	a,#0x25
	anl	a,_PINA
	orl	a,#0xc0
	mov	_PORTA,a
	C$main.c$552$1$324 ==.
;	main.c:552: PORTB = 0xFE; //PB[0,1]  (LCD RS, LCD RST) are overwritten by lcd2_portinit(), enable pull-ups for PB[2..7]  (PB[2,3] for buttons, PB[4..7] unused)
	mov	_PORTB,#0xfe
	C$main.c$553$1$324 ==.
;	main.c:553: PORTC = 0xF3 | (PINC & 0x08); // set PC0 = 1 (LCD SEL), PC1 = 1 (LCD SCK), PC2 = 0 (LCD MOSI), PC3 =0 (LED), enable pull-ups for PC[4..7] which are not bonded Mind: PORTC[0:1] is set to 0x3 by lcd2_portinit()
	mov	a,#0x08
	anl	a,_PINC
	orl	a,#0xf3
	mov	_PORTC,a
	C$main.c$554$1$324 ==.
;	main.c:554: PORTR = 0xCB; // overwritten by ax5043_reset, ax5043_comminit()
	mov	_PORTR,#0xcb
	C$main.c$556$1$324 ==.
;	main.c:556: DIRA = 0x27; // output 0 on PA[0,1,2,5] to prevent current consumption in all DIP switch states. Other PA are inputs, PA[3,4] (LPXOSC) must have disabled digital output drivers
	mov	_DIRA,#0x27
	C$main.c$557$1$324 ==.
;	main.c:557: DIRB = 0x03; // PB[0,1] are outputs (LCD RS, LCD RST), PB[2..7] are inputs (PB[2,3] for buttons,  PB[4..7]  unused)
	mov	_DIRB,#0x03
	C$main.c$558$1$324 ==.
;	main.c:558: DIRC = 0x0F; // PC[0..3] are outputs (LCD SEL, LCD,SCK, LCD MOSI, LED), PC[4..7] are inputs (not bonded).
	mov	_DIRC,#0x0f
	C$main.c$559$1$324 ==.
;	main.c:559: DIRR = 0x15; // overwritten by ax5043_reset, ax5043_comminit()
	mov	_DIRR,#0x15
	C$main.c$562$1$324 ==.
;	main.c:562: axradio_setup_pincfg1();
...
;	main.c:565: EIE = 0x00;
	mov	_EIE,#0x00
	C$main.c$566$1$324 ==.
;	main.c:566: E2IE = 0x00;
	mov	_E2IE,#0x00
	C$main.c$568$1$324 ==.
;	main.c:568: GPIOENABLE = 1; // unfreeze GPIO
	mov	dptr,#_GPIOENABLE
	mov	a,#0x01
	movx	@dptr,a
	C$main.c$572$1$324 ==.
;	main.c:572: return !coldstart; // coldstart -> return 0 -> var initialization; start from sleep -> return 1 -> no var initialization
	mov	a,_coldstart
	cjne	a,#0x01,00111$
00111$:
	mov  __sdcc_external_startup_sloc0_1_0,c
...
;	main.c:586: __endasm;
	...
	C$main.c$590$1$329 ==.
;	main.c:590: dbglink_init();
	lcall	_dbglink_init
	C$main.c$593$1$329 ==.
;	main.c:593: EA = 1;
	setb	_EA
	C$main.c$595$1$329 ==.
;	main.c:595: flash_apply_calibration();
	lcall	_flash_apply_calibration
	C$main.c$596$1$329 ==.
;	main.c:596: CLKCON = 0;
	mov	_CLKCON,#0x00
	C$main.c$597$1$329 ==.
;	main.c:597: wtimer_init();
	lcall	_wtimer_init
	C$main.c$602$2$332 ==.
;	main.c:602: uint8_t i = axradio_init();
	lcall	_axradio_init
	C$main.c$603$2$332 ==.
;	main.c:603: if (i != AXRADIO_ERR_NOERROR) {
	mov	a,dpl
	mov	r7,a
	jz	00115$
	C$main.c$604$3$333 ==.
;	main.c:604: if (i == AXRADIO_ERR_NOCHIP) {
	cjne	r7,#0x05,00111$
	C$main.c$607$4$334 ==.
;	main.c:607: if (DBGLNKSTAT & 0x10)
	mov	a,_DBGLNKSTAT
	jb	acc.4,00192$
	ljmp	00149$
00192$:
	C$main.c$608$4$334 ==.
;	main.c:608: dbglink_writestr("No AX5043 RF\nchip found");
	mov	dptr,#___str_2
	mov	b,#0x80
	lcall	_dbglink_writestr
	C$main.c$610$4$334 ==.
;	main.c:610: goto terminate_error;
	ljmp	00149$
	C$main.c$612$3$333 ==.
;	main.c:612: display_radio_error(i);
00111$:
	C$main.c$614$3$333 ==.
;	main.c:614: dbglink_display_radio_error(i);
	mov	dpl,r7
	lcall	_dbglink_display_radio_error
	C$main.c$616$3$333 ==.
;	main.c:616: goto terminate_error;
	ljmp	00149$
	C$main.c$618$2$332 ==.
;	main.c:618: display_writestr("found AX5043\n");
00115$:
	C$main.c$620$2$332 ==.
;	main.c:620: if (DBGLNKSTAT & 0x10)
	mov	a,_DBGLNKSTAT
	jnb	acc.4,00118$
	C$main.c$621$2$332 ==.
;	main.c:621: dbglink_writestr("found AX5043\n");
	mov	dptr,#___str_3
	mov	b,#0x80
	lcall	_dbglink_writestr
00118$:
	C$main.c$627$1$329 ==.
;	main.c:627: if(DBGLNKSTAT & 0x10) {
	mov	a,_DBGLNKSTAT
	jnb	acc.4,00122$
	C$main.c$628$2$338 ==.
;	main.c:628: dbglink_writestr("RNG=");
	mov	dptr,#___str_4
	mov	b,#0x80
	lcall	_dbglink_writestr
	C$main.c$629$2$338 ==.
;	main.c:629: dbglink_writenum16(axradio_get_pllrange(), 2, 0);
	...
	dec	sp
	C$main.c$631$3$339 ==.
;	main.c:631: uint8_t x = axradio_get_pllvcoi();
	lcall	_axradio_get_pllvcoi
	C$main.c$632$3$339 ==.
;	main.c:632: if (x & 0x80) {
	mov	a,dpl
	mov	r7,a
	jnb	acc.7,00120$
	C$main.c$633$4$340 ==.
;	main.c:633: dbglink_writestr("\nVCOI=");
	mov	dptr,#___str_5
	mov	b,#0x80
	push	ar7
	lcall	_dbglink_writestr
	pop	ar7
	C$main.c$634$4$340 ==.
;	main.c:634: dbglink_writehex16(x, 2, 0);
	clr	a
	mov	r6,a
	push	acc
	mov	a,#0x02
...
00120$:
	C$main.c$637$2$338 ==.
;	main.c:637: dbglink_writestr("\n\n");
	mov	dptr,#___str_6
	mov	b,#0x80
	lcall	_dbglink_writestr
00122$:
	C$main.c$654$1$329 ==.
;	main.c:654: axradio_setup_pincfg2();
...
00147$:
	C$main.c$710$2$342 ==.
;	main.c:710: wtimer_runcallbacks();
	lcall	_wtimer_runcallbacks
	C$main.c$711$2$342 ==.
;	main.c:711: EA = 0;
	clr	_EA
	C$main.c$713$3$342 ==.
;	main.c:713: uint8_t flg = WTFLAG_CANSTANDBY;
	mov	r7,#0x02
	C$main.c$715$3$343 ==.
;	main.c:715: if (axradio_cansleep()
	push	ar7
	...
	jz	00137$
	C$main.c$717$3$343 ==.
;	main.c:717: && dbglink_txidle()
	lcall	_dbglink_txidle
	mov	a,dpl
	jz	00137$
	C$main.c$720$3$343 ==.
;	main.c:720: flg |= WTFLAG_CANSLEEP;
	mov	r7,#0x03
00137$:
	C$main.c$722$3$343 ==.
;	main.c:722: wtimer_idle(flg);
	mov	dpl,r7
	lcall	_wtimer_idle
	C$main.c$724$2$342 ==.
;	main.c:724: EA = 1;
	setb	_EA
	C$main.c$726$1$329 ==.
;	main.c:726: terminate_error:
	sjmp	00147$
00149$:
	C$main.c$728$2$344 ==.
;	main.c:728: wtimer_runcallbacks();
	lcall	_wtimer_runcallbacks
	C$main.c$730$3$344 ==.
;	main.c:730: uint8_t flg = WTFLAG_CANSTANDBY;
	mov	r7,#0x02
	C$main.c$732$3$345 ==.
;	main.c:732: if (axradio_cansleep()
	push	ar7
	lcall	_axradio_cansleep
	mov	a,dpl
	pop	ar7
	jz	00143$
	C$main.c$734$3$345 ==.
;	main.c:734: && dbglink_txidle()
	lcall	_dbglink_txidle
	mov	a,dpl
	jz	00143$
	C$main.c$737$3$345 ==.
;	main.c:737: flg |= WTFLAG_CANSLEEP;
	mov	r7,#0x03
00143$:
	C$main.c$739$3$345 ==.
;	main.c:739: wtimer_idle(flg);
	mov	dpl,r7
	lcall	_wtimer_idle
	sjmp	00149$
	C$main.c$742$1$329 ==.
