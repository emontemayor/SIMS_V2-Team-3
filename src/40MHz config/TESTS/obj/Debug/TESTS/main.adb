...
F:Fmain$correct_ber$0$0({2}DF,SV:S),C,0,0,0,0,0
F:Fmain$process_ber$0$0({2}DF,SV:S),C,0,0,0,0,0
F:Fmain$dump_pkt$0$0({2}DF,SV:S),C,0,0,0,0,0
F:Fmain$display_ber$0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$axradio_statuschange$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$set_cw$0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$set_transmit$0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$set_receiveber$0$0({2}DF,SV:S),C,0,0,0,0,0
...
T:Fmain$__00000001[({0}S:S$w$0$0({2}SI:U),Z,0,0)({0}S:S$l$0$0({4}SL:U),Z,0,0)({0}S:S$b$0$0({4}STu32endian:S),Z,0,0)]
...
S:G$scr$0$0({4}ST__00000001:S),E,0,0
S:G$bytes$0$0({4}SL:U),E,0,0
S:G$errors$0$0({4}SL:U),E,0,0
S:G$errors2$0$0({4}SL:U),E,0,0
S:G$acquire_agc$0$0({1}SC:U),E,0,0
S:Lmain.pwrmgmt_irq$pc$1$228({1}SC:U),R,0,0,[r7]
S:Lmain.process_ber$st$1$233({2}DX,STaxradio_status:S),R,0,0,[r6,r7]
S:Lmain.process_ber$fourfsk$1$234({1}SC:U),E,0,0
S:Lmain.process_ber$i$2$235({1}SC:U),R,0,0,[r3]
S:Lmain.process_ber$p$3$237({2}DX,SC:U),R,0,0,[r6,r7]
S:Lmain.process_ber$databyte$6$240({1}SC:U),E,0,0
S:Lmain.process_ber$databyte$5$241({1}SC:U),R,0,0,[r4]
S:Lmain.process_ber$databyte$5$242({1}SC:U),R,0,0,[]
S:Lmain.process_ber$databyte$5$243({1}SC:U),R,0,0,[]
S:Lmain.process_ber$databyte$5$244({1}SC:U),R,0,0,[]
S:Lmain.process_ber$sloc0$1$0({1}SC:U),E,0,0
S:Lmain.process_ber$sloc1$1$0({2}DX,SC:U),E,0,0
S:Lmain.dump_pkt$st$1$246({2}DX,STaxradio_status:S),R,0,0,[r6,r7]
S:Lmain.dump_pkt$p$2$248({2}DX,SC:U),R,0,0,[]
S:Lmain.dump_pkt$i$2$248({1}SC:U),R,0,0,[r6]
S:Lmain.dump_pkt$j$2$248({1}SC:U),R,0,0,[r7]
S:Lmain.display_ber$st$1$251({2}DX,STaxradio_status:S),R,0,0,[r6,r7]
S:Lmain.display_ber$freqoffs$1$252({4}SL:S),R,0,0,[r4,r5,r6,r7]
S:Lmain.axradio_statuschange$st$1$262({2}DX,STaxradio_status:S),R,0,0,[r6,r7]
S:Lmain.axradio_statuschange$i$4$270({1}SC:U),R,0,0,[]
S:Lmain.axradio_statuschange$i$4$272({1}SC:U),R,0,0,[]
S:Lmain.axradio_statuschange$i$6$280({1}SC:U),R,0,0,[]
S:Lmain.axradio_statuschange$p$7$281({2}DX,SC:U),R,0,0,[]
S:Lmain.set_cw$i$1$285({1}SC:U),R,0,0,[r6]
S:Lmain.set_transmit$i$1$295({1}SC:U),R,0,0,[r6]
S:Lmain.set_receiveber$i$1$311({1}SC:U),R,0,0,[r6]
S:Lmain._sdcc_external_startup$c$2$325({1}SC:U),R,0,0,[]
S:Lmain._sdcc_external_startup$p$2$325({1}SC:U),R,0,0,[]
S:Lmain._sdcc_external_startup$c$2$326({1}SC:U),R,0,0,[]
S:Lmain._sdcc_external_startup$p$2$326({1}SC:U),R,0,0,[]
S:Lmain.main$i$2$332({1}SC:U),R,0,0,[r7]
S:Lmain.main$x$3$339({1}SC:U),R,0,0,[r7]
S:Lmain.main$flg$3$343({1}SC:U),R,0,0,[r7]
S:Lmain.main$flg$3$345({1}SC:U),R,0,0,[r7]
...
S:G$txdata$0$0({8}DA8d,SC:U),F,0,0
...
S:Fmain$correct_ber$0$0({2}DF,SV:S),C,0,0
S:Fmain$process_ber$0$0({2}DF,SV:S),C,0,0
S:Fmain$dump_pkt$0$0({2}DF,SV:S),C,0,0
S:Fmain$display_ber$0$0({2}DF,SV:S),C,0,0
S:G$set_cw$0$0({2}DF,SV:S),C,0,0
S:G$set_transmit$0$0({2}DF,SV:S),C,0,0
S:G$set_receiveber$0$0({2}DF,SV:S),C,0,0
...
S:G$txpattern$0$0({8}DA8d,SC:U),D,0,0
S:G$onepattern$0$0({8}DA8d,SC:U),D,0,0
S:Fmain$__str_0$0$0({9}DA9d,SC:S),D,0,0
S:Fmain$__str_1$0$0({10}DA10d,SC:S),D,0,0
S:Fmain$__str_2$0$0({24}DA24d,SC:S),D,0,0
S:Fmain$__str_3$0$0({14}DA14d,SC:S),D,0,0
S:Fmain$__str_4$0$0({5}DA5d,SC:S),D,0,0
S:Fmain$__str_5$0$0({7}DA7d,SC:S),D,0,0
S:Fmain$__str_6$0$0({3}DA3d,SC:S),D,0,0
