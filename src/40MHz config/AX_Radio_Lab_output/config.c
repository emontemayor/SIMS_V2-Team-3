...
// TX: fcarrier=169.000MHz dev=  0.500kHz br=  1.200kBit/s pwr=  0.0dBm
// RX: fcarrier=169.000MHz bw= 39.000kHz br=  1.200kBit/s
...
__reentrantb void ax5043_set_registers(void) __reentrant
{
	...
	AX5043_PINFUNCDCLK             = 0x02;
	AX5043_PINFUNCDATA             = 0x02;
	AX5043_PINFUNCANTSEL           = 0x02;
	AX5043_PINFUNCPWRAMP           = 0x02;
	AX5043_WAKEUPXOEARLY           = 0x01;
	AX5043_IFFREQ1                 = 0x06;
	AX5043_IFFREQ0                 = 0x66;
	AX5043_DECIMATION              = 0x05;
	AX5043_RXDATARATE2             = 0x05;
	AX5043_RXDATARATE1             = 0x35;
	AX5043_RXDATARATE0             = 0x55;
	AX5043_MAXDROFFSET2            = 0x00;
	AX5043_MAXDROFFSET1            = 0x00;
	AX5043_MAXDROFFSET0            = 0x00;
	AX5043_MAXRFOFFSET2            = 0x80;
	AX5043_MAXRFOFFSET1            = 0x29;
	AX5043_MAXRFOFFSET0            = 0x89;
	AX5043_FSKDMAX1                = 0x22;
	AX5043_FSKDMAX0                = 0xC0;
	AX5043_FSKDMIN1                = 0xDD;
	AX5043_FSKDMIN0                = 0x40;
	AX5043_AMPLFILTER              = 0x00;
	AX5043_RXPARAMSETS             = 0xF4;
	AX5043_AGCGAIN0                = 0xE8;
	AX5043_AGCTARGET0              = 0x84;
	AX5043_TIMEGAIN0               = 0xAD;
	AX5043_DRGAIN0                 = 0xA7;
...
const uint32_t __code axradio_phy_chanfreq[1] = { 0x0a900001 };
...
const int32_t __code axradio_phy_maxfreqoffset = 31898;
...
const int8_t __code axradio_phy_rssireference = 0xF7 + 64;
const int8_t __code axradio_phy_channelbusy = -90 + 64;
...
const uint16_t __code axradio_phy_preamble_wor_longlen = 1; // wor_longlen + wor_len totals to 240.0ms plus 64bits
...
const uint8_t __code axradio_framing_lenoffs = 4;
...
const uint32_t __code axradio_framing_ack_timeout = 82; // 125.7ms in wtimer0 units (640Hz)
...
// synchronous mode
const uint32_t __code axradio_sync_period = 120325; // ACTUALLY FREQ, NOT PERIOD!
const uint32_t __code axradio_sync_xoscstartup = 49;
const uint32_t __code axradio_sync_slave_syncwindow = 360973; // 11.016s
...
const int16_t __code axradio_sync_slave_maxperiod = 3141; // in (2^SYNC_K1) * wtimer0 units
...
const uint32_t __code axradio_sync_slave_rxadvance[] = { 3341, 3289, 3565 };// 101.931ms, 100.344ms, 108.767ms
const uint32_t __code axradio_sync_slave_rxwindow[] = { 3436, 3332, 3884 }; // 104.830ms, 101.657ms, 118.502ms
const uint32_t __code axradio_sync_slave_rxtimeout = 3550; // 108.3ms, maximum duration of a packet
