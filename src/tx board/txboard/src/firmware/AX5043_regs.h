/**********************************************
 * AX5043_regs.h
 * Header that defines all the registers for the AX5043
 *
 * Author : Dan Filbey
 * Capstone Project 2017 - 2018
 **********************************************/
#ifndef AX5043_REGS_H_
#define AX5043_REGS_H_
...
#define AX5043_TRKAFSKDEMOD1     0x054   /* AFSK Demodulator Tracking 1 !! NOT IN DATA SHEET */
#define AX5043_TRKAFSKDEMOD0     0x055   /* AFSK Demodulator Tracking 0 !! NOT IN DATA SHEET*/
/* Timer */
...
#define AX5043_FREQUENCYCYLEAK   0x116   /* Baseband Frequency Recovery Loop Leakiness */
...
#define AX5043_AGCAHYST0         0x122
#define AX5043_AGCMINMAX0        0x123
#define AX5043_TIMEGAIN0         0x124
#define AX5043_DRGAIN0           0x125
#define AX5043_PHASEGAIN0        0x126
#define AX5043_FREQGAINA0        0x127
#define AX5043_FREQGAINB0        0x128
#define AX5043_FREQGAINC0        0x129
#define AX5043_FREQGAIND0        0x12A
#define AX5043_AMPLGAIN0         0x12B
#define AX5043_FREQDEV10         0x12C
#define AX5043_FREQDEV00         0x12D
#define AX5043_FOURFSK0          0x12E
...
#define AX5043_FREQGAINA1        0x137
#define AX5043_FREQGAINB1        0x138
#define AX5043_FREQGAINC1        0x139
#define AX5043_FREQGAIND1        0x13A
#define AX5043_AMPLGAIN1         0x13B
...
#define AX5043_AGCGAIN2          0x140
#define AX5043_AGCTARGET2        0x141
#define AX5043_AGCAHYST2         0x142
#define AX5043_AGCMINMAX2        0x143
#define AX5043_TIMEGAIN2         0x144
#define AX5043_DRGAIN2           0x145
#define AX5043_PHASEGAIN2        0x146
#define AX5043_FREQGAINA2        0x147
#define AX5043_FREQGAINB2        0x148
#define AX5043_FREQGAINC2        0x149
#define AX5043_FREQGAIND2        0x14A
#define AX5043_AMPLGAIN2         0x14B
#define AX5043_FREQDEV12         0x14C
#define AX5043_FREQDEV02         0x14D
#define AX5043_FOURFSK2          0x14E
#define AX5043_BBOFFSRES2        0x14F
...
#define AX5043_FREQGAINA3        0x157
#define AX5043_FREQGAINB3        0x158
#define AX5043_FREQGAINC3        0x159
#define AX5043_FREQGAIND3        0x15A
#define AX5043_AMPLGAIN3         0x15B
...
#define AX5043_PKTADDR3          0x204
#define AX5043_PKTADDR2          0x205
#define AX5043_PKTADDR1          0x206
#define AX5043_PKTADDR0          0x207
#define AX5043_PKTADDRMASK3      0x208
#define AX5043_PKTADDRMASK2      0x209
#define AX5043_PKTADDRMASK1      0x20A
#define AX5043_PKTADDRMASK0      0x20B
/* Pattern Match */
...
/* Registers not in Datasheet */
#define AX5043_POWCTRL1          0xF08   /* Power Control 1 !!NOT IN DATASHEET */
#define AX5043_REF               0xF0D   /* Reference !!NOT IN DATASHEET */
#define AX5043_XTALOSC           0xF10   /* Crystal Oscillator Control !!NOT IN DATASHEET*/
#define AX5043_XTALAMPL          0xF11   /* Crystal Oscillator Amplitude Control !!NOT IN DATASHEET*/
#define AX5043_MODCFGP           0xF5F   /* Modulator Configuration P !!NOT IN DATASHEET*/

/* Tuning registers */
#define AX5043_0xF00               0xF00
#define AX5043_0xF0C               0xF0C
#define AX5043_0xF0D               0xF0D
#define AX5043_0xF10               0xF10
#define AX5043_0xF11               0xF11
...
#define AX5043_0xF72               0xF72

/* PWRMODE commands */
#define AX5043_POWERDOWN    0b0000
#define AX5043_DEEPSLEEP    0b0001
#define AX5043_STANDBY      0b0101
#define AX5043_FIFOON       0b0111
#define AX5043_SYNTHRX      0b1000
#define AX5043_FULLRX       0b1001
#define AX5043_WORRX        0b1011
#define AX5043_SYNTHTX      0b1100
#define AX5043_FULLTX       0b1101

/* FIFO chunk headers */
#define FIFO_NOP            0b00000000
#define FIFO_RSSI           0b00110001
#define FIFO_TXCTRL         0b00111100
#define FIFO_FREQOFFS       0b01010010
#define FIFO_ANTRSSI2       0b01010101
#define FIFO_REPEATDATA     0b01100010
#define FIFO_TIMER          0b01110000
#define FIFO_RFFREQOFFS     0b01110011
#define FIFO_DATARATE       0b01110100
#define FIFO_ANTRSSI3       0b01110101
#define FIFO_DATA           0b11100001
#define FIFO_TXPWR          0b11111101

/* FIFOCMD bit values */
#define FIFOCMD_NOP         0b000000
#define FIFOCMD_ASKCOH      0b000001
#define FIFOCMD_CLRERR      0b000010
#define FIFOCMD_CLRFIFO     0b000011
#define FIFOCMD_COMMIT      0b000100
#define FIFOCMD_ROLLBACK    0b000101
#endif /* AX5043_REGS_H_ */
