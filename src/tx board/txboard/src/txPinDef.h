...
#define UTX915			PINMUX_PA08D_SERCOM2_PAD0
#define URX915			PINMUX_PA09D_SERCOM2_PAD1
#define RTS915			PIN_PA10
#define CTS915			PIN_PA11
#define WAKE915			PIN_PA14
#define UART915_BAUD    115200
#define UART915_PINMUX  USART_RX_1_TX_0_RTS_2_CTS_3

//169 module
#define SPI169			SERCOM2
#define SPI169_PINXMUX   SPI_SIGNAL_MUX_SETTING_D
#define MOSI169			PINMUX_PA22C_SERCOM2_PAD0
#define SCK169			PINMUX_PA23C_SERCOM2_PAD1
#define SS169			PIN_PA24
#define MISO169			PINMUX_PA25C_SERCOM2_PAD3
#define IRQ169			PIN_PA27
