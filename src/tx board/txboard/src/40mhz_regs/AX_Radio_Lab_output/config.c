...
// TX: fcarrier= 70.000MHz dev=  0.033kHz br=  0.100kBit/s pwr= 15.0dBm
// RX: fcarrier= 70.000MHz bw= 18.000kHz br=  0.100kBit/s
...
__reentrantb void ax5043_set_registers(void) __reentrant
{
	...
	AX5043_FRAMING                 = 0x26;
	AX5043_PINFUNCSYSCLK           = 0x00;
	AX5043_PINFUNCDCLK             = 0x00;
	AX5043_PINFUNCDATA             = 0x00;
	AX5043_PINFUNCANTSEL           = 0x00;
	AX5043_PINFUNCPWRAMP           = 0x00;
	AX5043_WAKEUPXOEARLY           = 0x01;
	AX5043_IFFREQ1                 = 0x03;
	AX5043_IFFREQ0                 = 0x33;
	AX5043_DECIMATION              = 0x0B;
	AX5043_RXDATARATE2             = 0x0F;
	AX5043_RXDATARATE1             = 0xFF;
	AX5043_RXDATARATE0             = 0xFF;
	AX5043_MAXDROFFSET2            = 0x00;
	AX5043_MAXDROFFSET1            = 0x00;
	AX5043_MAXDROFFSET0            = 0x00;
	AX5043_MAXRFOFFSET2            = 0x80;
	AX5043_MAXRFOFFSET1            = 0x11;
	AX5043_MAXRFOFFSET0            = 0x34;
	AX5043_FSKDMAX1                = 0xC5;
	AX5043_FSKDMAX0                = 0x00;
	AX5043_FSKDMIN1                = 0x3B;
	AX5043_FSKDMIN0                = 0x00;
	AX5043_AMPLFILTER              = 0x00;
	AX5043_RXPARAMSETS             = 0xF4;
	AX5043_AGCGAIN0                = 0xEB;
	AX5043_AGCTARGET0              = 0x84;
	AX5043_TIMEGAIN0               = 0x8F;
	AX5043_DRGAIN0                 = 0x89;
...
const uint32_t __code axradio_phy_chanfreq[1] = { 0x028AE149 };
...
const int32_t __code axradio_phy_maxfreqoffset = 13212;
...
const uint16_t __code axradio_phy_preamble_wor_longlen = 0; // wor_longlen + wor_len totals to 240.0ms plus 128bits
const uint16_t __code axradio_phy_preamble_wor_len = 152;
const uint16_t __code axradio_phy_preamble_longlen = 0;
const uint16_t __code axradio_phy_preamble_len = 128;
...
const uint32_t __code axradio_framing_ack_timeout = 88885; // 2712.5ms in wtimer0 units (32768Hz)
...
// synchronous mode
const uint32_t __code axradio_sync_period = 98304; // ACTUALLY FREQ, NOT PERIOD!
const uint32_t __code axradio_sync_xoscstartup = 49;
const uint32_t __code axradio_sync_slave_syncwindow = 294912; // 9.000s
...
const int16_t __code axradio_sync_slave_maxperiod = 2859; // in (2^SYNC_K1) * wtimer0 units
...
const uint32_t __code axradio_sync_slave_rxadvance[] = { 59714, 59699, 62663 };// 1822.312ms, 1821.854ms, 1912.308ms
const uint32_t __code axradio_sync_slave_rxwindow[] = { 60668, 60638, 66566 }; // 1851.426ms, 1850.511ms, 2031.419ms
const uint32_t __code axradio_sync_slave_rxtimeout = 81920; // 2500.0ms, maximum duration of a packet
