...
//40 module
#define SPI40			SERCOM1
#define SPI40_PINXMUX   SPI_SIGNAL_MUX_SETTING_O
#define MOSI40			PINMUX_PA16C_SERCOM1_PAD0
#define SCK40			PINMUX_PA19C_SERCOM1_PAD3
#define SS40			PIN_PA17
#define MISO40			PINMUX_PA18C_SERCOM1_PAD2
#define IRQ40			PIN_PB16
...
#define UART_FIBER  	SERCOM5
#define UTX_FIBER		PINMUX_PA20C_SERCOM5_PAD2
//#define URX_FIBER		PINMUX_PA17C_SERCOM1_PAD1
#define UART_FIBER_BAUD 14400
#define UART_FIBER_PINMUX  USART_RX_0_TX_2_XCK_3
#define UART_FIBER_CLK  GCLK_GENERATOR_0

//27 module
#define SPI27			SERCOM3
#define SPI27_PINXMUX   SPI_SIGNAL_MUX_SETTING_E
